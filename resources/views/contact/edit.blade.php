        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <option value="1" @if($contact->age === 1) selected @endif>〜19際</option>
                    <option value="2" @if($contact->age === 2) selected @endif>20歳〜29際</option>
                    <option value="3" @if($contact->age === 3) selected @endif>30歳〜39際</option>
                    <option value="4" @if($contact->age === 4) selected @endif>40歳〜49際</option>
                    <option value="5" @if($contact->age === 5) selected @endif>50歳〜59際</option>
